...
//   const [priceRange, setPriceRange] = useState([0, 50]); // Set initial price range
...
//   const currentProducts = props.products.products.slice(
//     firstProductIndex,
//     lastProductIndex
//   );
...
//   for (
//     let i = 1;
//     i <= Math.ceil(props.products.products.length / productsPerPage);
//     i++
//   ) {
//     pages.push(i);
//   }
...
//     return props.filterByCategoryAction(category);
//   };

//   const filterByPriceRange = () => {
//     props.filterByPriceRangeAction(priceRange);
//   };
...
//                     max={50} // Set the max value based on your maximum price
//                   />
//                   <Typography>
//                     Price: ${priceRange[0]} - ${priceRange[1]}
//                   </Typography>

//                   <button onClick={()=> filterByPriceRange()} className="filterPriceBtn">Filter</button>
//                 </div>
//               </div>
